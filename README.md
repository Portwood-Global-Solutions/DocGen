...
[![Version](https://img.shields.io/badge/version-3.46.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx000000s7yzIAA --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000s7yzIAA) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000s7yzIAA)
...
| ------- | --------------------------------------- | -------------------- |
| v3.46.0 | **Latest (Released)**                   | `04tVx000000s7yzIAA` |
