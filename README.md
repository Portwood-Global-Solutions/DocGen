...
[![Version](https://img.shields.io/badge/version-3.38.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx000000rEmPIAU --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rEmPIAU) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rEmPIAU)
...
| ------- | --------------------------------------- | -------------------- |
| v3.38.0 | **Latest (Released)**                   | `04tVx000000rEmPIAU` |
