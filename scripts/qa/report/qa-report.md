...
**Org** `docgen-verify` · **Run** 2026-07-25T17:15:29.883Z · **Duration** 1096s

## Headline

|                       |              |
| --------------------- | ------------ |
| Checks evaluated      | 1463         |
| Passed                | 1291 (88.2%) |
| Failed                | 172          |
...
| `apex-unit`      | Apex unit                |     23 |     33 |       0 | 41.1% |
| `apex-e2e`       | Apex end-to-end          |     12 |      2 |       0 | 85.7% |
...
| ----------- | ---------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **blocker** | `apex-unit`      | Apex tests ran                                                                                                 | Command failed: sf apex run test --target-org docgen-verify --wait 45 --result-format json --class-names BarcodeGeneratorTest --class-names DocGenAcroFormServiceTest --class-names DocGenAssetTest --class-names DocGenAuthenticatorControllerT                                                             |
| **blocker** | `apex-e2e`       | Permissions: e2e-01-permissions.apex                                                                           | 2 of 48 assertions failed                                                                                                                                                                                                                                                                                    |
| **major**   | `apex-unit`      | DocGenApprovalHistory has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenAssetKeyHandler has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenChartFont has a test class                                                                               | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenContentDocumentCleanupQueueable has a test class                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenDataProvider has a test class                                                                            | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenEmailTemplateController has a test class                                                                 | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenEmailTemplateInstall has a test class                                                                    | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenEmailTemplateService has a test class                                                                    | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenFlowAction has a test class                                                                              | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenGiantQueryAssembler has a test class                                                                     | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenGiantQueryBatch has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenGiantQueryStitchJob has a test class                                                                     | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenMergeJob has a test class                                                                                | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenPdfPreparedBodyQueueable has a test class                                                                | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenPdfSaveQueueable has a test class                                                                        | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenPngEncoder has a test class                                                                              | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenService has a test class                                                                                 | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureController has a test class                                                                     | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureEmailService has a test class                                                                   | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureExpiry has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureFinalizer has a test class                                                                      | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureGuestSecurity has a test class                                                                  | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignaturePdfFlowAction has a test class                                                                  | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureReminderSchedulable has a test class                                                            | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureSenderController has a test class                                                               | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureService has a test class                                                                        | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureSubmitter has a test class                                                                      | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSignatureValidator has a test class                                                                      | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSigner has a test class                                                                                  | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenSvgChartSerializer has a test class                                                                      | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | DocGenTemplateManager has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-unit`      | HeapPressureException has a test class                                                                         | no \*Test class references this class name — untested surface                                                                                                                                                                                                                                                |
| **major**   | `apex-e2e`       | Signature lifecycle: e2e-06b-signature-lifecycle.apex                                                          | 1 of 1 assertions failed                                                                                                                                                                                                                                                                                     |
...
- `ui-admin` — closing the modal with unsaved edits warns or preserves them: could not re-open the modal: row "QAUI-0my4r5-Starter": the menu never offered a visible "Edit" item
...
- ✅ BarcodeGenerator has a test class
- ✅ DocGenAcroFormService has a test class
- ❌ DocGenApprovalHistory has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenAssetKeyHandler has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenAuthenticatorController has a test class
- ✅ DocGenBatch has a test class
- ✅ DocGenBulkController has a test class
- ✅ DocGenBulkFlowAction has a test class
- ✅ DocGenBulkGiantFallbackJob has a test class
- ✅ DocGenButtonAdminController has a test class
- ✅ DocGenButtonController has a test class
- ✅ DocGenChartBucketResolver has a test class
- ❌ DocGenChartFont has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenChartImageController has a test class
- ✅ DocGenChartRasterizer has a test class
- ✅ DocGenChartTagExpander has a test class
- ❌ DocGenContentDocumentCleanupQueueable has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenController has a test class
- ❌ DocGenDataProvider has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenDataRetriever has a test class
- ❌ DocGenEmailTemplateController has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenEmailTemplateInstall has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenEmailTemplateService has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenErrorLogger has a test class
- ✅ DocGenFieldWritebackService has a test class
- ❌ DocGenFlowAction has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenFlsGuard has a test class
- ❌ DocGenGiantQueryAssembler has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenGiantQueryBatch has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenGiantQueryFlowAction has a test class
- ❌ DocGenGiantQueryStitchJob has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenGuestRenderQueueable has a test class
- ✅ DocGenHtmlRenderer has a test class
- ❌ DocGenMergeJob has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenPdfPreparedBodyQueueable has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenPdfSaveQueueable has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenPngEncoder has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenService has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenSetupController has a test class
- ❌ DocGenSignatureController has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureEmailService has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureExpiry has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureFinalizer has a test class — no \*Test class references this class name — untested surface
- ✅ DocGenSignatureFlowAction has a test class
- ❌ DocGenSignatureGuestSecurity has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignaturePdfFlowAction has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureReminderSchedulable has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureSenderController has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureService has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureSubmitter has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSignatureValidator has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSigner has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenSvgChartSerializer has a test class — no \*Test class references this class name — untested surface
- ❌ DocGenTemplateManager has a test class — no \*Test class references this class name — untested surface
- ❌ HeapPressureException has a test class — no \*Test class references this class name — untested surface
- ❌ Apex tests ran — Command failed: sf apex run test --target-org docgen-verify --wait 45 --result-format json --class-names BarcodeGeneratorTest --class-names DocGenAcroFormServiceTest --class-names DocGenAssetTest --cl

### apex-e2e — Apex end-to-end

- ❌ Permissions: e2e-01-permissions.apex — 2 of 48 assertions failed
- ✅ Template CRUD: e2e-02-template-crud.apex — 10 assertions
- ✅ PDF generation: e2e-03-generate-pdf.apex — 14 assertions
- ✅ Page setup: e2e-03b-page-setup.apex — 0 assertions
...
- ❌ Signature lifecycle: e2e-06b-signature-lifecycle.apex — 1 of 1 assertions failed
...
- ✅ Cleanup: e2e-08-cleanup.apex — 12 assertions
...
- ✅ {Now:yyyy-MM-dd HH:mm} formats a timestamp — actual: 2026-07-25 10:16
...
- ✅ HTML→PDF: generation returned bytes — 75097 bytes
- ✅ HTML→PDF: magic bytes are %PDF — leading bytes 255044462D312E34, expected 25504446
- ✅ HTML→PDF: size above 800 bytes — 75097 bytes
...
- ✅ Document_Title_Format\_\_c produces the document title — expected "QAOF999847607-QAOF999847607 Corp-Technology", got "QAOF999847607-QAOF999847607 Corp-Technology"
...
- ✅ Word→DOCX: Document_Title_Format\_\_c applied — expected "QAOF999847607-QAOF999847607 Corp", got "QAOF999847607-QAOF999847607 Corp"
...
- ✅ PDF AcroForm: merged value is written into the PDF — expected "QAOF999847607 Corp" in the filled PDF bytes; A_MERGED=true
...
- ✅ Deactivated version with an attached file yields a valid PDF or a clean error, never a corrupt one — size=66659 hex=255044462D312E34 threw=false
- ✅ Zero-row child loop: generation returned bytes — 67768 bytes
- ✅ Zero-row child loop: magic bytes are %PDF — leading bytes 255044462D312E34, expected 25504446
- ✅ Zero-row child loop: size above 800 bytes — 67768 bytes
...
- ✅ Header image: generation returned bytes — 90890 bytes
- ✅ Header image: magic bytes are %PDF — leading bytes 255044462D312E34, expected 25504446
- ✅ Header image: size above 800 bytes — 90890 bytes
...
- ✅ Missing image CV: generation returned bytes — 68025 bytes
- ✅ Missing image CV: magic bytes are %PDF — leading bytes 255044462D312E34, expected 25504446
- ✅ Missing image CV: size above 800 bytes — 68025 bytes
...
- ✅ Very large document body: valid PDF or a clean, catchable error — size=505636 hex=255044462D312E34 at body length 1152000
- ✅ Very large document body: PDF is complete, not truncated — %%EOF trailer present in 505636 bytes
- ✅ Very large document body: output size reflects the content — 1152000-char body → 505636 bytes of PDF
...
- ✅ Giant-query PDF: generation returned bytes — 109329 bytes
- ✅ Giant-query PDF: magic bytes are %PDF — leading bytes 255044462D312E34, expected 25504446
- ✅ Giant-query PDF: size above 30000 bytes — 109329 bytes
- ✅ Giant-query PDF is complete, not truncated — %%EOF trailer present in 109329 bytes
- ✅ Giant-query output is named from Document_Title_Format\_\_c — ContentVersion.Title was "QAOF999847607-giant-QAOF999847607 Giant", expected it to start with "QAOF999847607-giant-"
...
- ✅ Designer tab offers templates to open when none is loaded — {"list":true,"count":8,"first":"ffffAccountDesign →"}
- ✅ template list stays bounded regardless of org size — 8 rendered · Showing 8 of 11 · 11 total
...
- ✅ wizard Back returns to step 1 and keeps what was typed — onStep1=true name="QAUI-0my4r5-File" (expected "QAUI-0my4r5-File")
...
- ✅ the wizard creates a template record end to end — a0BO500000OrDm5MAF, base object Account
...
- ✅ the starter path creates the template record — a0BO500000OrDnhMAF, HTML/PDF
...
- ✅ search narrows the list to matching rows only — 13 -> 2 rows for "0my4r5"; every remaining row matches = true
...
- ✅ clicking a column header re-orders the rows both ways — clicked=true; first row "QAUI-0my4r5-Starter HTML PDF" -> asc "Account HTML PDF Account Act" -> desc "Verify — Landscape Precedenc"
...
- ✅ row action Export downloads a valid .docgen.json bundle — QAUI-0my4r5-Starter.docgen.json — export version 1, template "QAUI-0my4r5-Starter"
- ✅ Import Template restores an exported bundle as a new template — "QAUI-0my4r5-Imported" exists after import
- ✅ row action Clone creates a copy and opens it for editing — created "QAUI-0my4r5-File (Copy)" (a0BO500000Or3FJMAZ); the edit modal opened = true
- ✅ row action Delete removes the template — "QAUI-0my4r5-File (Copy)" is gone from the org
...
- ✅ edit modal inputs accept real typing — description="edited by ui-admin 0my4r5" category="QA0my4r5"
- ✅ the Active toggle flips when clicked — checked true -> false
- ✅ Save as New Version persists the edited fields — stored description="edited by ui-admin 0my4r5", category="QA0my4r5" (expected "edited by ui-admin 0my4r5" / "QA0my4r5")
- ✅ Save as New Version really creates a new version record — template versions 0 -> 1
- ⊘ closing the modal with unsaved edits warns or preserves them — could not re-open the modal: row "QAUI-0my4r5-Starter": the menu never offered a visible "Edit" item
...
- ✅ pressing Run creates a bulk job on the server — DocGen_Job\_\_c a03O500003h2xRWIAY status Completed
...
- ✅ the failing job records WHY each record failed — Error_Log\_\_c = 001O5000040kX9mIAE — portwoodglobal.DocGenException: Error retrieving template data: No template file found (active or attached). 001O5000040kX9nIAE — portwoodglobal.DocGenException: Er
- ✅ the Recent Jobs list shows the error count to the user — Recent Jobs did not show "UIQA-ms0n7696-err" with "2 errors" — a user would see the run as finished with no indication anything went wrong
