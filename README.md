...
[![Version](https://img.shields.io/badge/version-3.39.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx000000rGkzIAE --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rGkzIAE) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rGkzIAE)
...
| ------- | --------------------------------------- | -------------------- |
| v3.39.0 | **Latest (Released)**                   | `04tVx000000rGkzIAE` |
