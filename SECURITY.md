...
If you discover a security vulnerability in Portwood, **please do not open a public issue.**
...
Portwood is designed with Salesforce security best practices:
...
- **Permission-gated access.** All admin/user functionality requires the Portwood Admin or Portwood User permission set; guest signing requires the Portwood Guest Signature permission set assigned to the Site guest user.
