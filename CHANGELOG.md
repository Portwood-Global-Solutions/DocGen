...
Two fixes to the HTML-template → PDF (Flying Saucer / `Blob.toPdf`) image pipeline, reported in #support by Michael Jackson and Nathan M on v3.22.0. Also carries the v3.25.0 guest-signing work (its beta `3.25.0-1` was never promoted).
