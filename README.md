...
[![Version](https://img.shields.io/badge/version-3.43.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx000000rkeDIAQ --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rkeDIAQ) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000rkeDIAQ)
...
| ------- | --------------------------------------- | -------------------- |
| v3.43.0 | **Latest (Released)**                   | `04tVx000000rkeDIAQ` |
