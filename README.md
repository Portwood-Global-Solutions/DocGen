...
[![Version](https://img.shields.io/badge/version-3.52.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx000000zz6bIAA --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zz6bIAA) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zz6bIAA)
...
| ------- | --------------------------------------- | -------------------- |
| v3.52.0 | **Latest (Released)**                   | `04tVx000000zz6bIAA` |
