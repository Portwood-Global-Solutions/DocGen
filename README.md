...
[![Version](https://img.shields.io/badge/version-3.54.0-blue.svg)](#install)
...
```bash
sf package install --package 04tVx0000010Y4LIAU --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx0000010Y4LIAU) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx0000010Y4LIAU)
...
| ------- | --------------------------------------- | -------------------- |
| v3.54.0 | **Latest (Released)**                   | `04tVx0000010Y4LIAU` |
