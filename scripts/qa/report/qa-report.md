...
- ✅ docGenRunner renders on a record page — rendered 521 chars, 2 picker(s), 1 primary button(s)
...
- ✅ the record-page template picker lists a template the user can actually run — picker showed: Choose a template... / Account / [Test] E2E Test Template / ffff / playa / test / Test2 / test3 / test345 / test99 / [UIQA] UIQA Good PDF / [UIQA] UIQA Locked Format / [UIQA] UIQA No Ve
...
- ✅ the packet chooser offers the record's PDF templates — chooser offered 15 template(s): Account / E2E Test Template / ffff / playa / test / Test2
