...
[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zvz3IAA) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zvz3IAA)
...
**Portwood DocGen Agentforce Extension** `04tVx000000s82DIAQ` adds _Generate with
Agentforce_: describe a document and DocGen writes the template, or ask for a
change in plain English and it revises the one you have. Requires DocGen 3.46+
and Einstein/Prompt Builder, and is installation-key protected — [get in
touch](https://portwood.dev/support) for the key.
...
it optional is what lets DocGen install everywhere. See
...
| ------- | --------------------------------------- | -------------------- |
| v3.49.0 | **Latest (Released)**                   | `04tVx000000zvz3IAA` |
