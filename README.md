...
```bash
sf package install --package 04tVx000000zxWDIAY --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zxWDIAY) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVx000000zxWDIAY)
...
| ------- | --------------------------------------- | -------------------- |
| v3.51.0 | **Latest (Released)**                   | `04tVx000000zxWDIAY` |
